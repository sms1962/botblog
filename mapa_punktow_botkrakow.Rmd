---
title: "Mapa punktów w Krakowie"
description: |
  Mapa zawierająca opublikowane przez bota [botkrakow](https://twitter.com/botkrakow), punkty w Krakowie

base_url: https://botblog.netlify.app
creative_commons: CC BY
preview: images/map_botkrakow.png
...
twity <- read_csv("https://raw.githubusercontent.com/sms1962/BotKrakow/master/data/archiwum_twitow.csv", 
...
mapview::mapshot(m, file = "images/map_botkrakow.png", remove_controls = c("zoomControl", "layersControl", "homeButton", "scaleBar","drawToolbar", "easyButton"))
