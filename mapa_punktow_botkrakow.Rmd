...
twity <- read_csv("./data/botkrakow_archiwum_twitow.csv", 
...
mapview::mapshot(m, file = "images/mapa_botkrakow.png", remove_controls = c("zoomControl", "layersControl", "homeButton", "scaleBar","drawToolbar", "easyButton"))
