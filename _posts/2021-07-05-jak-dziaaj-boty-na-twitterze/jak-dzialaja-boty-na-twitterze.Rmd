...
Zgodnie z naszym schematem zaczynamy od autoryzacji konta bota na Twitterze. Najpierw jednak musimy konto bota założyć. Odradzam uruchamianie bota na swoim "prywatnym" koncie, bo coś nie "pyknie", Twitter nam zablokuje i będzie problem. Nie znaczy to, że nie możemy urchamiać botów na "swoim" koncie. Można, ale przynajmniej pierwsze próby lepiej zrobić na zupełnie nowym. To przecież nic nie kosztuje.
...
Wystarczy rut oka, bo odgadnąć, że mogą zdarzyć się punkt, który będzie poza grnicami administracyjnymi Krakowa, ale wewnątrz bbox. Wówczas bot może publikować zdjęcie jak poniżej, z którego trudno odgadnąć co to za miejsce :-)
...
Aby móc ściągać zdjęcia z MapBoksa muimy założyć konto (bezpłatne). Jest ono potrzebne by usyskać dostęp do unikalnego tokenu, którym serwer MapBox będzie nas identyfikował. Token jest jak hasło, to znaczy nie udostępniamy go nikomu.
...
Zmienna *img_url* prechowywać będzie adres powstały z połączenia (funkcja *paste0() )* wszystkich elementów przedzielonych pzecinkami, czyli:
...
-   "",15,0/850x500" - 15 to poziom powiększenia (zoom), a "850x500" to wielkość zdjęcia sateliatrnego w pikselach.
...
Mając adres internetowy, przechodzimy do pobierania zdjęcia staelitarnego z serwisu MapBox.
...
Całość kodu na moim koncie w [Github](https://github.com/sms1962/BotKrakow). Ma kilka różnic wynikających z faktu, że dzięki Github Actions działa na obcym (Githuba) serwerze. Więcej na temat jak zautomatyzować bota, by działał co np. godzinę, w nastepnym wpisie.
